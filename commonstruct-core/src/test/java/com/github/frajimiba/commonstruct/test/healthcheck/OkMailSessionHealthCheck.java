...
public class OkMailSessionHealthCheck extends AbstractMailSessionHealthCheck {
  ...
  public MailSession getMailSession() {
    return new MailSession(){
      ...
      public Session getMailSession() {
        ...
        props.put("mail.smtp.user", "user@test.com");
        ...
        props.put("mail.smtp.from", "user@test.com");
