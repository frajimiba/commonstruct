package com.github.frajimiba.commonstruct.spring.domain;
...
@MappedSuperclass
public abstract class SpringEntity<PK extends Serializable> implements Entity<PK> {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof SpringEntity) {
      if (this == obj) {
        result = true;
      } else {
        SpringEntity<?> that = (SpringEntity<?>) obj;
