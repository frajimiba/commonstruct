...
@MappedSuperclass
@Audited
public abstract class SpringUser<PK extends Serializable> extends SpringEntity<PK> implements User<PK> {
   ...
   *          the credentials that prove the principal is correct
   */
  public SpringUser(String principal, String credentials) {
  ...
  @Override
  public abstract Collection<? extends SpringRole<?>> getRoles();
